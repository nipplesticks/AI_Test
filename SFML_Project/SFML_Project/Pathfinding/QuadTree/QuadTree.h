...
public:
	...
	Entity * DispatchRay(const sf::Vector2f & rayStart, const sf::Vector2f & rayEnd, std::vector<unsigned long long> * avoid = nullptr) const;
...
private:
	...
	void _traverseWithRay(const sf::Vector2f & rayStart, const sf::Vector2f & rayEnd, int quadIndex, float & t, Entity *& ePtr, std::vector<unsigned long long> * avoid) const;
